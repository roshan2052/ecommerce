...
@section('content')
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Products Images</a> <a href="#" class="current">Products Alternative Images</a> </div>
            <h1>Products Alternative Images</h1>
